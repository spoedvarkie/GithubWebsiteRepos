...
function searchTextbook($title){
	...
	$sql = "SELECT T.TEXTBOOK_TITLE, T.TEXTBOOK_EDITION, T.TEXTBOOK_PRICE, A.AUTHOR_INITIALS, A.AUTHOR_L_NAME FROM textbook T, author A, textbook_author TA WHERE T.TEXTBOOK_TITLE LIKE '%". $title. "%' AND T.TEXTBOOK_ID = TA.TEXTBOOK_ID AND TA.AUTHOR_ID = A.AUTHOR_ID";
